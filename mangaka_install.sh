...
COIN_DAEMON='mangakad'
COIN_CLI='mangaka-cli'
...
purgeOldInstallation() {
    ...
    #kill wallet daemon
    sudo killall mangakad > /dev/null 2>&1
    #remove old ufw port allow
    sudo ufw delete allow 9711/tcp > /dev/null 2>&1
    #remove old files
    if [ -d "~/.mangaka" ]; then
        sudo rm -rf ~/.mangaka > /dev/null 2>&1
    fi
    #remove binaries and Mangaka utilities
    cd /usr/local/bin && sudo rm mangaka-cli mangaka-tx mangakad > /dev/null 2>&1 && cd
...
function important_information() {
 echo
 echo -e "${BLUE}================================================================================================================================${NC}"
 echo -e "${PURPLE}Windows Wallet Guide. https://github.com/Realbityoda/Mangaka/blob/master/README.md${NC}"
 echo -e "${BLUE}================================================================================================================================${NC}"
