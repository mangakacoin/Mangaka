![Example-Logo](https://i.imgur.com/O7DmlZN.png)
# Mangaka Masternode Setup Guide (Ubuntu 16.04)
This guide will assist you in setting up a Mangaka Masternode on a Linux Server running Ubuntu 16.04. (Use at your own risk)

If you require further assistance contact the support team @ [Discord](https://discord.gg/qrUgkvC)
***
## Requirements
1) **1,000  Mangaka coins.**
...
`wget -q https://raw.githubusercontent.com/Realbityoda/Mangaka/master/mangaka_install.sh`
***

***Step 8***
* Paste the code below into the Bitvise terminal then press enter

`bash mangaka_install.sh`
...
***Step 1***
* Download and install the Mangaka wallet [here](https://github.com/mangakacoin/Mangaka-Core/releases/tag/v.10.0.0.3)
***

***Step 2***
* Send EXACLY 1,000 MANG to a receive address within your wallet.
***
